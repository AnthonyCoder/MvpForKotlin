...
import com.anthony.mvp.module_gank.R
...
class GankFragment : BaseFragment<GankPresenter>(), GankContact.View {
    ...
    override val layoutId = R.layout.fragment_gank
    ...
    override fun setGankData(resultsBeanList: List<GankImageResult.ResultsBean>) {
