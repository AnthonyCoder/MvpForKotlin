...
import com.anthony.common.base.net.client.request.child.TestRequestClient
...
class TestActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        testLogRequestBean = TestLogRequestBean().apply {
            accessToken =
                "8ig+PInAx/iQAcFt8HP35wwzFUd8XMYjvva8SH0ZchR+Y+X9rSjKZYi+0Adonk9k1mrsp8LjUxliGkO7hGnVcvrZV5tpZS0OxKtPjtuZhsc="
            appName = "JiboHealth"
            cultureCode = "zh-cn"
            device = deviceData
        }
    ...
    private fun doPostRequest() {
        TestRequestClient.client.executeRequest(
            RequestAction.RawPostAction(testLogRequestBean),
            UrlConstant.POST_MESSAGE_LOG,
            object : AppObserver<MessageLogResult>() {
