...
class ProjectPageFragment : BaseLazyFragment<ProjectPagePresenter>(), ProjectPageContact.View {
    ...
    var pageId = 0
    override val layoutId = R.layout.fragment_project_page
    ...
    override fun initView() {
        ...
        rv_home_page.addItemDecoration(
            LinearItemDecoration(mActivity)
                .height(0.8f)    // 0.5dp
    ...
    override fun projectList(modelList: List<ProjectListResult.DataBean.DatasBean>) {
